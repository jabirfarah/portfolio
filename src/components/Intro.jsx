  ...
  return (
    <div className="flex items-center justify-center flex-col text-center pt-20 pb-12 ">
        ...
        <div className=" flex flex-row gap-3">
          ...
          >
            <svg
              ...
              height="2em"
              viewBox="0 0 496 512"
              className="fill-current text-black dark:text-white text-center"
            >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            className="rounded-lg flex items-center justify-center text-center cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="2em"
              viewBox="0 0 24 24"
              className="fill-current text-black dark:text-white text-center cursor-pointer"
            >
      ...
      <a
        ...
        rel="noreferrer noopener"
        type="button"
        className="inline-block text-center px-8 py-3 w-max text-base font-medium rounded-md text-white bg-stone-900 dark:bg-white dark:text-stone-700 drop-shadow-md mt-1 cursor-pointer"
      >
        View My Resume
      </a>
    </div>
