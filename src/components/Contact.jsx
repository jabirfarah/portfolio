        ...
        <div className='flex flex-col mb-10 mx-auto'>
            ...
            <div className='flex justify-center items-center'>
                ...
                className='flex flex-col w-full md:w-7/12'>
                    ...
                    <button type='submit' className='inline-block text-center px-8 py-3 w-max text-base font-medium rounded-md text-white bg-gradient-to-r bg-stone-900 dark:bg-white dark:text-stone-700 drop-shadow-md'>Contact Me</button>
                </form>
            </div>
        </div>
    )
